...
public static class ModelStateUtils
{
    ...
    public static ObjectResult GenNotFound(this ControllerBase controller)
    {
        return controller.StatusCode(StatusCodes.Status404NotFound, GenProblem(StatusCodes.Status404NotFound, controller.ModelState));
    }
}